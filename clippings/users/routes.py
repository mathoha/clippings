...
from clippings import db, bcrypt
from clippings.models import User, Post
from clippings.users.forms import (RegistrationForm, LoginForm, UpdateAccountForm,
                                   RequestResetForm, ResetPasswordForm)
from clippings.users.utils import save_picture, send_reset_email
...
def account():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('users.account')) #want to do redirect because of "POST GET Redirect Pattern"
